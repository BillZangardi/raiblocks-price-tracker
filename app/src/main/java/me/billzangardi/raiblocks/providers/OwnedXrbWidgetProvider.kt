...
class OwnedXrbWidgetProvider : BaseWidgetProvider() {
    override fun updateViews(context: Context?, appWidgetManager: AppWidgetManager?, appWidgetIds: IntArray?, displayBtc: Boolean, displayUsd: Boolean, displayEuro: Boolean, displayPound: Boolean, backgroundHex: String?, fontHex: String?) {
        ...
        if(!TextUtils.isEmpty(fontHex) && ViewUtil.isColorHex(fontHex!!)) {
            remoteViews.setTextColor(R.id.owned, Color.parseColor(fontHex))
            remoteViews.setTextColor(R.id.bitcoin_value, Color.parseColor(fontHex))
            remoteViews.setTextColor(R.id.usd_value, Color.parseColor(fontHex))
            remoteViews.setTextColor(R.id.eur_value, Color.parseColor(fontHex))
            remoteViews.setTextColor(R.id.gbp_value, Color.parseColor(fontHex))
        }
