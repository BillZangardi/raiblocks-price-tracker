package me.billzangardi.raiblocks.features.base
...
import me.billzangardi.raiblocks.RaiApplication
import me.billzangardi.raiblocks.injection.component.ConfigPersistentComponent
import me.billzangardi.raiblocks.injection.component.DaggerConfigPersistentComponent
import me.billzangardi.raiblocks.injection.component.FragmentComponent
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (sComponentsArray.get(mFragmentId) == null) {
            ...
            configPersistentComponent = DaggerConfigPersistentComponent.builder()
                    .applicationComponent(RaiApplication[activity].component)
                    .build()
